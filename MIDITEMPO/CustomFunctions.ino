...
void measureSteps(uint8_t fullMeasure,uint8_t *newColors, uint8_t *oldColors){
     switch(fullMeasure){   
      ...
      case 2:
        ...
        setPixel(8, newColors[0],newColors[1],newColors[2]); 
        break;
      case 3:
        setPixel(8, oldColors[0],oldColors[1],oldColors[2]);
        setPixel(12, newColors[0],newColors[1],newColors[2]); 
        break; 
      default:
        setPixel(12, oldColors[0],oldColors[1],oldColors[2]);
        fullMeasure = 0;
        break;
  }
}
